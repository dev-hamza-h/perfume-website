...
const Hero: React.FC = () => {
  return (
    <section className="relative bg-black text-white min-h-screen flex items-center py-10">
      <div className="container mx-auto flex flex-col md:flex-row-reverse items-center px-6 md:px-12 lg:px-24 space-y-6 md:space-y-0">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center h-full text-center md:text-left space-y-4">
          ...
          <div className="mt-6 md:mt-14">
            <button className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-md font-semibold text-lg mx-auto md:mx-0">
              Shop Now
            </button>
          </div>
        </div>
